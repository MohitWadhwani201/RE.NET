...
<%
    ...
    Userdto user=dao.getUserData(userId);
    ...
    long contact = Long.parseLong(user.getContact());
...
<div class="theme-layout">
			...
			<ul>
				...
				<li><span>Account Setting</span>
					<ul>
						...
						<li><a href="editWorkEducation.jsp" title="">edit work educations</a></li>
	...
	<div class="topbar stick">
		<div class="logo">
			<a title="" href="home.jsp"><img src="images/logo.png" alt=""></a>
		</div>
			...
			<ul class="main-menu">
				...
				<li>
					...
					<ul>
						...
						<li><a href="editProfilePage.jsp" title="">edit account setting</a></li>
						<li><a href="edit-interest.html" title="">edit-interest</a></li>
						...
						<div class="timeline-info">
							<ul>
								...
								<li>
									...
									<a class="active" href="profile.jsp" title="" data-ripple="">about</a>
								...
								<aside class="sidebar static">
									...
									<ul class="naves">
										<li>
											...
											<a title="" href="editProfilePage.jsp">Basic info</a>
										</li>
										<li>
											<i class="ti-mouse-alt"></i>
											<a title="" href="editWorkEducation.jsp">Education &amp; Work</a>
										</li>
										<li>
											<i class="ti-heart"></i>
											...
											<div class="tab-content">
												<div class="tab-pane fade show active" id="basic" >
													<ul class="basics">
                                                                                                                ...
                                                                                                                <li><i class="ti-user"></i><%=username%></li>
														<li><i class="ti-map-alt"></i>live in <%=state%> ,India</li>
														<li><i class="ti-mobile"></i><%=contact%></li>
                                                                                                                <li><i class="ti-email"></i><u style="text-transform: lowercase"><%=email%></u></li>
												...
												<div class="tab-pane fade" id="location" role="tabpanel">
													<div >
                                                                                                            <div>
                                                                                                                <ul class="basics"><li> City: <%=city%></li>
															<li> State: <%=state%></li>
                                                                                                                </ul>
                                                                                                                </div>
													</div>
												...
												<div class="tab-pane fade" id="work" role="tabpanel">
													<div>
														...
														<a href="#" title="">Work and Education</a>
														<p>Studying</p> 
														<ul class="education">
															<li> Schooling from Sarafa Vidya Niketan</li>
															<li> Btech from Indore Institute of Science and Technology</li>
														</ul>
													</div>
												</div>
